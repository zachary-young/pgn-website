          ...
          {data[this.state.filterIndex].data.map((obj,index) => {
            return (
              <div key={index} className="filter-widget__card">
                <Image fadeIn="false" className={(type === "brothers") ? "card__photo card__photo--tall" : "card__photo card__photo--short"} fluid={(type === "brothers") ? obj.node.headshot.fluid : obj.node.photo.fluid} alt={type}/>
